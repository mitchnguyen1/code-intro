...
// CODE HERE
let total = netflix + hulu + disney + youtube_premium + peacock
console.log(total)
...
// CODE HERE
let newTotal = netflix + hulu + disney + youtube_premium + peacock
...
let savingsRound = Math.round(((total-newTotal)/total) * 100)
console.log(`Savings: ${savings}%`)
console.log(`Savings Rounded: ${savingsRound}%`)
